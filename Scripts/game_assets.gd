...
const COLOR_SELECTOR_TEXTURES = {
	Color.BLUE: [preload("res://Assets/Selector_buttons/blue_selector.png"), preload("res://Assets/Selector_buttons/blue_selector.png")],
...
const OLD_COLOR_SELECTOR_TEXTURES = {
	Color.BLUE: [preload("res://Assets/Selector_buttons/blue_selector_button.png"), preload("res://Assets/Selector_buttons/blue_selector_button.png")],
	Color.GREEN: [preload("res://Assets/Selector_buttons/green_selector_button.png"), preload("res://Assets/Selector_buttons/green_selector_button.png")],
	Color.RED: [preload("res://Assets/Selector_buttons/red_selector_button.png"), preload("res://Assets/Selector_buttons/red_selector_button.png")],
	Color.YELLOW: [preload("res://Assets/Selector_buttons/yellow_selector_button.png"), preload("res://Assets/Selector_buttons/yellow_selector_button.png")]
}
